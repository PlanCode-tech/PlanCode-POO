...
import javax.swing.*;
import java.awt.*;
import main.TelaSelecao;  // Importa a TelaLogin do pacote main
...
public class TelaLogin extends JFrame {
    ...
    public TelaLogin() {
        ...
        setIconImage(new ImageIcon("src/img/logoPlanCode.jpg").getImage());
        ...
        // Logo
        String caminhoLogo = "/img/logoPlanCode.jpg";
        try {
        ...
        btnEntrar.addActionListener(e -> {
            ...
            if (usuario.equals("POO") && senha.equals("poo123")) {
                // Abre a TelaLogin (menu principal)
                TelaSelecao menu = new TelaSelecao();
                menu.setVisible(true);
                dispose(); // Fecha a TelaSelecao
            } else {
